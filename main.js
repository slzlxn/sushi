...
//웹에서 데이터를 클라이언트(자기pc)측에 영구적으로 저장할 수 있게 해주는 저장소입니다.
...
ScrollReveal().reveal(
  ".home_img,.home_data,.about_data,.about_img,.recently_img,.popular_card,.footer_description,.footer_content,.footer_info",
  {
    origin: "top",
    distance: "60px",
    duration: 2500,
...
let scrollActive = () => {
  ...
  sections.forEach((current) => {
    ...
    let sectionTop = current.offsetTop - 60; //자기영역이 시작되는 지점,나의 머리가 천장에 닿는 지점
